...
{
    public partial class sitemap_ingredients : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtSiteMapIngredient = IngredientLanguage.GetIngredientSiteMap(IDLanguage);

            if(dtSiteMapIngredient.Rows.Count > 0)
            {
                foreach(DataRow _dr in dtSiteMapIngredient.Rows)
                {

...
{
    public partial class ctrlUserBoardStatus : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtStatus.Attributes.Add("onkeypress", "return clickButton(event,'" + ibtnStatus.ClientID + "')");
        }

        #region ibtnStatus_Click
        protected void ibtnStatus_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(txtStatus.Text))
                {
                    ...
                    UserBoard NewUserBoardAction = new UserBoard(IDUserGuid, null, ActionTypes.PersonalMessage, null, txtStatus.Text, null, DateTime.UtcNow, MyConvert.ToInt32(HttpContext.Current.Session["IDLanguage"].ToString(), 1));

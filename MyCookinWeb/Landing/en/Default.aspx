<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MyCookinWeb.Landing.en.Default" %>
                ...
                <tr>
                    <td>
                        <object height="350" width="425">
                            <param name="movie" value="http://www.youtube.com/v/FtypkE9Kfls" />
                            <embed height="350" src="http://www.youtube.com/v/FtypkE9Kfls&autoplay=1" type="application/x-shockwave-flash" width="550" /></embed>
                        </object>
                    </td>
                    <td>
                        <a href="http://www.mycookin.com/en/recipe/Carrot-and-pumpkin-soup/e690f707-3eae-4869-9ea8-ae1de868e397" target="_blank" border="0">
            ...
            <table border="0" cellspacing="10" cellpadding="0" width="900">
                <tr>
                    <td width="250">
                        ...
                        <asp:ImageButton ID="loginFacebook" class="loginbox" ImageUrl="../images/facebook_button.png"
                    ...
                    <td>
                        ...
                        <br />
                        <br />
                        <iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fmycookinenglish&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=476759249023668" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;" allowTransparency="true"></iframe>
                    </td>
                </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MyCookinWeb.Landing.it.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            ...
            <!--<iframe width="550" height="315" src="//www.youtube.com/embed/CvICBoTZXYU&autoplay=1" frameborder="0" autoplay="1" allowfullscreen></iframe>-->

            <table border="0" cellspacing="0" cellpadding="0" width="900">
                <tr>
                    <td>
                        <object height="350" width="425">
                            <param name="movie" value="http://www.youtube.com/v/CvICBoTZXYU" />
                            <embed height="350" src="http://www.youtube.com/v/CvICBoTZXYU&autoplay=1" type="application/x-shockwave-flash" width="550" /></embed>
                        </object>
                    </td>
                    <td>
                        <a href="http://www.mycookin.com/it/ricetta/vellutata-di-carote-e-zucca/e690f707-3eae-4869-9ea8-ae1de868e397" target="_blank" border="0">
                            <img src="../images/vellutata-di-carote.jpg" width="50" style="float: left; margin: 0 10px 5px 10px;" />
                            <b>Ricetta del Mese</b>
                            <br />
                            Vellutata di Carote
                        </a>

                        <script async="async" src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                        <!-- MyCookin - Landing Ita 1 -->
            ...
            <table border="0" cellspacing="10" cellpadding="0" width="900">
                <tr>
                    <td width="250">
                        ...
                        <asp:ImageButton ID="loginFacebook" class="loginbox" ImageUrl="../images/facebook-button-it.png"
                    ...
                    <td>
                        ...
                        <br />
                        <br />
                        <iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fmycookin&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=476759249023668" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;" allowTransparency="true"></iframe>
                    </td>
                </tr>

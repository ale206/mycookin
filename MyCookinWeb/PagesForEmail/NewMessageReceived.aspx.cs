...
{
    public partial class NewMessageReceived :  MyCookinWeb.Form.MyPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //UTILIZED BY "MessageManager.asmx"
            ...
            string TextToShow = RetrieveMessage.RetrieveDBMessage(MyConvert.ToInt32(HttpContext.Current.Session["IDLanguage"].ToString(), 1), "US-IN-0059");

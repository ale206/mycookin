    ...
    public class MapForRecipe : Profile
    {
        public MapForRecipe()
        {
            ...
            CreateMap<IngredientQuantityTypeListOut, IngredientQuantityTypeListOutput>()
                .ForMember(dest => dest.LanguageId, opt => opt.MapFrom(src => src.IDLanguage))
                .ForMember(dest => dest.IngredientQuantityTypeId,
                    opt => opt.MapFrom(src => src.IDIngredientQuantityType))
                .ForMember(dest => dest.IngredientQuantityTypeLanguageId,
                    opt => opt.MapFrom(src => src.IDIngredientQuantityTypeLanguage));

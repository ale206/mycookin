...
namespace TaechIdeas.MyCookin.IoC
{
    public static class Setup
    {
        ...
        private static void RegisterAsScoped(this IServiceCollection serviceCollection,
        ...
        public static T GetService<T>(string appSettingToBeUsed = null)
        {
            ...
            if (serviceCollection != null) return _serviceProvider.GetService<T>();
            ...
            if (!string.IsNullOrEmpty(appSettingToBeUsed)) builder.AddJsonFile(appSettingToBeUsed, true);

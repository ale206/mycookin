!function() {
    ...
    (function() {
        function X(e) {
            ...
            function w(j) {
                if (!(j.type == "readystatechange" && x.readyState != "complete") &&
                    ((j.type == "load" ? n : x)[z](i + j.type, w, !1), !m && (m = !0))) e.call(n, j.type || j)
            }

            const Y = x.addEventListener;
            var m = !1, C = !0;
            const t = Y ? "addEventListener" : "attachEvent";
            var z = Y ? "removeEventListener" : "detachEvent",
                i = Y ? "" : "on";
        ...
        for (var n = window,
            ...
            const M = A[m];
            const T = M.src.match(/^[^#?]*\/run_prettify\.js(\?[^#]*)?(?:#.*)?$/);
            if (T) {
                z = T[1] || "";
            ...
            (function() {
                ...
                e.onload = e.onerror = e.onreadystatechange = function() {
                    if (e && (!e.readyState || /loaded|complete/.test(e.readyState)))
                        e.onerror = e.onload = e.onreadystatechange =
                            r, --R, R || P(Q, 0), e.parentNode && e.parentNode.removeChild(e), e = r
                };
                e.type =
                    "text/javascript";
            ...
            (function() {
                function j(a) {
                    function d(f) {
                        ...
                        return(b = i[a])
                            ? b
                            : "0" <= a && a <= "7"
                            ? parseInt(f.substring(1), 8)
                            : a === "u" || a === "x"
                            ? parseInt(f.substring(2), 16)
                            : f.charCodeAt(1)
                    }
                    ...
                    function b(f) {
                        var b = f.substring(1, f.length - 1)
                                .match(
                        ...
                        for (var a = a ? 1 : 0, g = b.length; a < g; ++a) {
                            ...
                            if (/\\[bdsw]/i.test(k)) c.push(k);
                                ...
                                o < 65 ||
                                    k > 122 ||
                                    (o < 65 || k > 90 || f.push([Math.max(65, k) | 32, Math.min(o, 90) | 32]), o < 97 ||
                                        k > 122 ||
                    ...
                    function e(f) {
                        ...
                        for (k = g = 0; g < c; ++g)
                            o = a[g], o === "("
                                ? (++k, d[k] || (a[g] = "(?:"))
                                : "\\" === o.charAt(0) && (o = +o.substring(1)) && o <= k && (a[g] = `\\${d[o]}`);
                        for (g = 0; g < c; ++g) "^" === a[g] && "^" !== a[g + 1] && (a[g] = "");
                        if (f.ignoreCase && F)
                            for (g = 0; g < c; ++g)
                                o = a[g], f = o.charAt(0), o.length >= 2 && f === "["
                                    ? a[g] = b(o)
                                    : f !== "\\" &&
                                    (a[g] = o.replace(/[A-Za-z]/g,
                                        function(a) {
                                            a = a.charCodeAt(0);
                ...
                function m(a, d) {
                    function h(a) {
                        ...
                        if (c == 1) {
                            ...
                            3 ||
                            c == 4)
                            c = a.nodeValue, c.length &&
                            (c = d ? c.replace(/\r\n?/g, "\n") : c.replace(/[\t\n\r ]+/g, " "), e[l] =
                                c, F[l << 1] = j, j += c.length, F[l++ << 1 | 1] = a)
                    }
                ...
                function x(a) {
                    for (var d = void 0, h = a.firstChild; h; h = h.nextSibling)
                        const b = h.nodeType;
                        var d = b === 1 ? d ? a : h : b === 3 ? S.test(h.nodeValue) ? a : d : d;
                    return d === a ? void 0 : d
                }
                ...
                function C(a, d) {
                    function h(a) {
                        for (var l = a.e,
                            ...
                            if (typeof y === "string") g = !1;
                                ...
                                if ((g = y.length >= 5 && "lang-" === y.substring(0, 5)) &&
                                    !(u && typeof u[1] === "string")) g = !1, y = "src";
                                g || (m[B] = y)
                            }
                            k = c;
                            c += B.length;
                    ...
                    (function() {
                        for (var h = a.concat(d), l = [], i = {}, c = 0, p = h.length; c < p; ++c) {
                            let m = h[c];
                            let q = m[3];
                            if (q) for (let f = q.length; --f >= 0;) b[q.charAt(f)] = m;
                            m = m[1];
                            q = `${m}`;
                    ...
                    if (b = a.regexLiterals) {
                        ...
                        h.push([
                            "lang-regex", RegExp(
                                ...
                                `/(?=[^/*${b}])(?:[^/\\x5B\\x5C${b}]|\\x5C${e}|\\x5B(?:[^\\x5C\\x5D${b}]|\\x5C${e
                                })*(?:\\x5D|$))+/`})`)
                        ])
                    }
                ...
                function z(a, d, h) {
                    function b(a) {
                        ...
                        if (c == 1 && !j.test(a.className))
                            ...
                            const i = d.match(m);
                            if (i)
                                c = d.substring(0, i.index), a.nodeValue =
                                    c, (d = d.substring(i.index + i[0].length)) &&
                                    a.parentNode.insertBefore(l.createTextNode(d), a.nextSibling), e(a), c ||
                    ...
                    function e(a) {
                        function b(a, c) {
                            ...
                            if (f) {
                                ...
                                let h = a.nextSibling;
                                f.appendChild(d);
                                for (let e = h; e; e = h) h = e.nextSibling, f.appendChild(e)
                            }
                            return d
                        }
                    ...
                    d === (d | 0) &&
                        c[0].setAttribute("value",
                            d);
                    const n = l.createElement("ol");
                ...
                function i(a, d) {
                    for (let h = d.length; --h >= 0;) {
                        const b = d[h];
                        U.hasOwnProperty(b)
                            ? V.console && console.warn("cannot override language handler %s", b)
                            : U[b] = a
                    }
                }
                        ...
                        try {
                            for (; b < n;) {
                                ...
                                if (E.nodeType !== 1 && (W = i.substring(h, u))) {
                                    ...
                                    h < o &&
                                    (l[b + 1] = E =
                                        Z.createTextNode(i.substring(u, o)), z.insertBefore(E, s.nextSibling))
                                }
                                h = u;
                                h >= o && (b += 2);
                                h >= H && (t += 2)
                ...
                i(C([["pln", /^\s+/, r, " \t\r\n"], ["atv", /^(?:"[^"]*"?|'[^']*'?)/, r, "\"'"]],
                        [
                            ...
                            ["lang-css", /^style\s*=\s*'([^']+)'/i], ["lang-css", /^style\s*=\s*([^\s"'>]+)/i]
                        ]),
                    ["in.tag"]);
                i(C([], [["atv", /^[\S\s]+/]]), ["uq.val"]);
                ...
                i(t({ keywords: M, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }),
                    ["cv", "py", "python"]);
                i(t({
                        keywords:
                            "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END",
                ...
                var X = V.PR = {
                    ...
                    prettyPrint: e = e = function(a, d) {
                        function e() {
                            for (var b = V.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity;
                                p < j.length && c.now() < b;
                                p++) {
                                        ...
                                        if (y.test(d.tagName)) s = 1;
                                            ...
                                            var s = d.currentStyle,
                                                ...
                                                s = (s = s
                                                        ...
                                                        ? v.getComputedStyle(d, r).getPropertyValue("white-space")
                                                        : 0) &&
                                                    "pre" === s.substring(0, 3);
                                        v = m.linenums;
                                        if (!(v = v === "true" || +v))
                        ...
                        for (var b = d || document.body,
                            ...
                            b = [
                                b.getElementsByTagName("pre"), b.getElementsByTagName("code"),
                                b.getElementsByTagName("xmp")
                            ],
                            j = [],
                            m = 0;
                            m < b.length;
                            ++m) for (var l = 0, n = b[m].length; l < n; ++l) j.push(b[m][l]);
                        var b = r, c = Date;

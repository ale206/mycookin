    ...
    init: function() {
        ...
        (function($) {
            ...
            $.fn[_iCheck] = function(options, fire) {
                ...
                if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(options)) {
                    ...
                    return stack.each(function() {
                        ...
                        const className = node[_type] == _checkbox
            ...
            function operate(input, direct, method) {
                const node = input[0];
                const state = /er/.test(method) ? _indeterminate : /bl/.test(method) ? _disabled : _checked;
                const active = method == _update
                    ? {
            ...
            function on(input, state, keep) {
                ...
                const callback = indeterminate ? _determinate : checked ? _unchecked : "enabled";

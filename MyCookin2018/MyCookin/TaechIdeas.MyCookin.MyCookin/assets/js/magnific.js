                    ...
                    proto: {
                        ...
                        getImage: function(item, template) {
                            ...
                            if (el.length) {
                                ...
                                item.img = $(img).on("load.mfploader", onLoadComplete)
                        ...
                        initZoom: function() {
                            ...
                            var duration = zoomSt.duration,
                                getElToAnimate = function(image) {
                                    const newImg = image.clone().removeAttr("style").removeAttr("class")
                                    ...
                                    cssObj[`-webkit-${t}`] = cssObj[`-moz-${t}`] = cssObj[`-o-${t}`] = cssObj[t] =
                                        transition;
                                ...
                                function() {
                                    if (mfp.items.length > 1 && gSt.arrows && !mfp.arrowLeft) {
                                        ...
                                        const arrowLeft = mfp.arrowLeft =
                                            $(markup.replace("%title%", gSt.tPrev).replace("%dir%", "left"))
                                            .addClass(PREVENT_CLOSE_CLASS);
                                        const arrowRight = mfp.arrowRight =
                                            $(markup.replace("%title%", gSt.tNext).replace("%dir%", "right"))
                                            .addClass(PREVENT_CLOSE_CLASS);

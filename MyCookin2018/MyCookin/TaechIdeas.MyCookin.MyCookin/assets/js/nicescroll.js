    ...
    init: function() {
        ...
        */
        ...
        (function(factory) {
            ...
            var getBrowserDetection = function() {
                ...
                d.ischrome26 =
                    (d.ischrome && ("transition" in domtest.style)); // issue with transform detection (maintain prefix)

                d.cantouch =
                    ("ontouchstart" in document.documentElement) ||
                    ("ontouchstart" in window); // detection for Chrome Touch Emulation
                ...
                d.transitionend = false;
                var check = [
                    "transition", "webkitTransition", "MozTransition", "OTransition", "OTransition", "msTransition",
                    "KhtmlTransition"
                ];
                var prefix = ["", "-webkit-", "-moz-", "-o-", "-o", "-ms-", "-khtml-"];
                var evs = [
                    "transitionend", "webkitTransitionEnd", "transitionend", "otransitionend", "oTransitionEnd",
            ...
            var NiceScrollClass = function(myopt, me) {
                ...
                this.isrtlmode =
                    false; //(this.opt.rtlmode=="auto") ? (this.win.css("direction")=="rtl") : (this.opt.rtlmode===true);
                ...
                BezierClass.prototype = {
                    ...
                    getNow: function() {
                        const nw = (new Date()).getTime();
                        const pc = 1 - ((nw - this.ts) / this.spd);
                        const bz = this.B2(pc) + this.B3(pc) + this.B4(pc);
                ...
                if (this.ishwscroll) {
                    ...
                    if (cap.hastranslate3d && cap.isios
                        ...
                        this.doc.css("-webkit-backface-visibility",
                            "hidden"); // prevent flickering http://stackoverflow.com/questions/3461441/      

                    //derived from http://stackoverflow.com/questions/11236090/
                    function getMatrixValues() {
                        const tr = self.doc.css(cap.trstyle);
                ...
                this.getOffset = function() {
                    ...
                    const ww = self.win.offset();
                    const vp = self.viewport.offset();
                    return {
        ...
        */
                            ...
                            self.onmangotouch = function(e) {
                                ...
                                if (((tm - self.mangotouch.tm) > 80) ||
                                    ...
                                    var ds = Math.max(Math.abs(self.mangotouch.ly - py),
                                ...
                                self.ontouchmove = function(e, byiframe) {
                                    ...
                                    if (self.rail.drag && (self.rail.drag.pt == 2)) {
                                        ...
                                        if (self.railh && self.railh.scrollable) {
                                            var nx = self.rail.drag.sl -
                                                mx;; //(self.isrtlmode) ? mx-self.rail.drag.sl : self.rail.drag.sl-mx;
                                        ...
                                        if (self.rail.drag.dl) {
                                            ...
                                            if (self.rail.drag.ck == "v") {
                                                if (ay > dz && (ax <= (ay * 0.3))) {
                                                    ...
                                                    self.rail.drag.dl = "f";
                                                    $("body").scrollTop($("body")
                                                        .scrollTop()); // stop iOS native scrolling (when active javascript has blocked)
                                                }
                                                ...
                                                if (ax > dz && (ay <= (ax * 0.3))) {
                                                    ...
                                                    self.rail.drag.dl = "f";
                                                    $("body").scrollLeft($("body")
                                                        .scrollLeft()); // stop iOS native scrolling (when active javascript has blocked)
                                                }
                                            }
                                        }
                            ...
                            self.onmousemove = function(e) {
                                if (self.rail.drag) {
                                    ...
                                    if (self.rail.drag.hr) {
                                        ...
                                        const mw = self.scrollvaluemaxw;
                                        if (self.scroll.x > mw) self.scroll.x = mw;
                                    } else {
                                        self.scroll.y = self.rail.drag.sy + (e.clientY - self.rail.drag.y);
                                        if (self.scroll.y < 0) self.scroll.y = 0;
                                        const my = self.scrollvaluemax;
        ...
        */
                            ...
                            if (cap.cantouch || self.opt.touchbehavior) {
                                ...
                                function checkSelectionScroll(e) {
                                    ...
                                    if (e) {
                                        const ww = self.win.outerHeight();
                                        let df = (e.pageY - self.selectiondrag.top);
                                        if (df > 0 && df < ww) df = 0;
                                        if (df >= ww) df -= ww;
                                    ...
                                    const rt = -Math.floor(self.selectiondrag.df / 6) * 2;
                                ...
                                self.onselectiondrag = function(e) {
                                    ...
                                    if (self.hasTextSelected())
                                        self.debounced("selectionscroll",
                                            function() {
        ...
        */
                            ...
                            if (self.opt.enablemousewheel) {
                                if (!self.isiframe)
                                    self.bind((cap.isie && self.ispage) ? document : self.win /*self.docscroll*/,
                                        "mousewheel",
                                        self.onmousewheel);
                        ...
                        if (!self.ispage && !self.haswrapper) {
                            ...
                            if (clsMutationObserver !== false) {
                                ...
                                if (cap.isie9
                                    ...
                                    self.win[0].attachEvent("onpropertychange",
                    ...
                    if (this.doc[0].nodeName == "IFRAME") {
                        function oniframeload(e) {
                            self.iframexd = false;
                            try {
                                var doc = "contentDocument" in this
                            ...
                            if (!cap.isios && self.opt.iframeautoresize && !self.isiframe) {
                                ...
                                var hh = Math.max(doc.getElementsByTagName("html")[0].scrollHeight,
                    ...
                    if (!self.rail.drag || self.rail.drag.pt != 1) {
                        ...
                        if (typeof px != "undefined") {
                            self.scroll.x =
                                Math.round(px *
                                    1 /
                                    self.scrollratio.x); //-cxscrollleft * Math.round(px * 1/self.scrollratio.x);
                        }
                    }
        ...
        */
                ...
                this.bind = function(dom, name, fn, bubble) { // touch-oriented & fixing jquery bind
                    ...
                    if (name == "mousewheel") {
                        if ("onwheel" in self.win) {
                            ...
                            const wname = (typeof document.onmousewheel != "undefined")
                                ? "mousewheel"
                ...
                this.unbindAll = function() {
                    for (let a = 0; a < self.events.length; a++) {
                        const r = self.events[a];
                ...
                this.remove = function() {
                    ...
                    for (let a = 0; a < self.saved.css.length; a++) {
                        const d = self.saved.css[a];
                    ...
                    lst.each(function(i) {
                        ...
                        if (this.id === self.id) {
                            delete lst[i];
                            for (let b = ++i; b < lst.length; b++, i++) lst[i] = lst[b];
                            lst.length--;
                ...
                this.isScrollable = function(e) {
                    ...
                    while (dom && (dom.nodeType == 1) && !(/^BODY|HTML/.test(dom.nodeName))) {
                        const dd = $(dom);
                        const ov = dd.css("overflowY") || dd.css("overflowX") || dd.css("overflow") || "";
                ...
                this.triggerScrollEnd = function() {
                    ...
                    const px = self.getScrollLeft();
                    const py = self.getScrollTop();
                ...
                function execScrollWheel(e, hr, chkscroll) {
                    ...
                    if (px) {
                        ...
                        self.lastdeltax += px;
                        self.debounced("mousewheelx",
                            function() {
                                const dt = self.lastdeltax;
                                self.lastdeltax = 0;
                                if (!self.rail.drag) {
                ...
                this.onmousewheel = function(e) {
                    ...
                    //      if (self.locked) return self.cancelEvent(e);
                    const ret = execScrollWheel(e, false, chk);
                ...
                this.getTransitionSpeed = function(dif) {
                    const sp = Math.round(self.opt.scrollspeed * 10);
                    const ex = Math.min(sp, Math.round((dif / 20) * self.opt.scrollspeed));
                    return (ex > 20) ? ex : 0;
                };

                if (!self.opt.smoothscroll) {
                    this.doScrollLeft = function(x, spd) { //direct
                        const y = self.getScrollTop();
                        self.doScrollPos(x, y, spd);
                    };
                    this.doScrollTop = function(y, spd) { //direct
                        const x = self.getScrollLeft();
                        self.doScrollPos(x, y, spd);
                    };
                    ...
                    this.prepareTransition = function(dif, istime) {
                        const ex = (istime) ? ((dif > 20) ? dif : 0) : self.getTransitionSpeed(dif);
                        const trans = (ex) ? cap.prefixstyle + "transform " + ex + "ms ease-out" : "";
                    ...
                    this.doScrollLeft = function(x, spd) { //trans
                        const y = (self.scrollrunning) ? self.newscrolly : self.getScrollTop();
                        self.doScrollPos(x, y, spd);
                    };

                    this.doScrollTop = function(y, spd) { //trans
                        const x = (self.scrollrunning) ? self.newscrollx : self.getScrollLeft();
                        self.doScrollPos(x, y, spd);
                    };
                    ...
                    this.doScrollPos = function(x, y, spd) { //trans
                        ...
                        self.timer = setTimeout(function() {
                                ...
                                const top = self.getScrollTop();
                                const lft = self.getScrollLeft();
                                ...
                                const dd = Math.round(Math.sqrt(Math.pow(dst.x, 2) + Math.pow(dst.y, 2)));
                                ...
                                if (ms > 0) {
                                    ...
                                    if (cap.transitionend) {
                                        ...
                                        self.scrollendtrapped =
                                            setTimeout(self.onScrollTransitionEnd, ms); // simulate transitionend event
                                    }
                    ...
                    this.doScrollPos = function(x, y, spd) { //no-trans
                        ...
                        if ((py == self.page.maxh && y >= self.page.maxh) ||
                            (px == self.page.maxw && x >= self.page.maxw)) self.checkContentSize();
        ...
        */
                ...
                this.doScrollBy = function(stp, relative) {
                    ...
                    if (relative) {
                        ...
                        const sy = (self.timer) ? self.newscrolly : self.getScrollTop(true);
                        ny = sy - stp;
                    }
                    if (self.bouncescroll) {
                        const haf = Math.round(self.view.h / 2);
                        if (ny < -haf) ny = -haf;
                ...
                this.doScrollLeftBy = function(stp, relative) {
                    ...
                    if (relative) {
                        ...
                        const sx = (self.timer) ? self.newscrollx : self.getScrollLeft(true);
                        nx = sx - stp;
                    }
                    if (self.bouncescroll) {
                        const haf = Math.round(self.view.w / 2);
                        if (nx < -haf) nx = -haf;
                ...
                this.doZoomIn = function(e) {
                    ...
                    const lst = [
                        "position", "top", "left", "zIndex", "backgroundColor", "marginTop", "marginBottom",
                        "marginLeft", "marginRight"
                    ];
                    const win = self.win[0].style;
                    for (let a in lst) {
                        const pp = lst[a];
                    ...
                    const bkg = self.win.css("backgroundColor");
                ...
                this.resizeZoom = function() {
                    ...
                    const py = self.getScrollTop(); //preserve scrolling position
                    self.win.css({
            ...
            var ScrollMomentumClass2D = function(nc) {
                ...
                this.update = function(px, py) {
                    ...
                    self.lasttime = now;
                    const dy = py - self.lasty;
                    const dx = px - self.lastx;
                    const sy = self.nc.getScrollTop();
                    const sx = self.nc.getScrollLeft();
                    const newy = sy + dy;
                    const newx = sx + dx;
                ...
                this.doMomentum = function(gp) {
                    var t = self.time();
                    const l = (gp) ? t + gp : self.lasttime;

                    const sl = self.nc.getScrollLeft();
                    const st = self.nc.getScrollTop();
                    ...
                    const sy = (self.speedy && chk) ? self.speedy : false;
                    const sx = (self.speedx && chk) ? self.speedx : false;
                        ...
                        var onscroll = function() {
                            ...
                            self.nc.synched("domomentum2d",
                                function() {
                                    ...
                                    if (self.speedx) {
                                        const scx = self.nc.getScrollLeft();
                                    ...
                                    if (self.speedy) {
                                        const scy = self.nc.getScrollTop();
            ...
            jQuery.cssHooks["pageYOffset"] = {
                get: function(elem, computed, extra) {
                    const nice = $.data(elem, "__nicescroll") || false;
        ...
        */
            ...
            jQuery.fn.scrollTop = function(value) {
                if (typeof value == "undefined") {
                    const nice = (this[0]) ? $.data(this[0], "__nicescroll") || false : false;
                    return (nice && nice.ishwscroll) ? nice.getScrollTop() : _scrollTop.call(this);
                } else {
                    return this.each(function() {
                        const nice = $.data(this, "__nicescroll") || false;
        ...
        */
            ...
            var NiceScrollArray = function(doms) {
                ...
                if (doms) {
                    for (let a = 0; a < doms.length; a++) {
                        const nice = $.data(doms[a], "__nicescroll") || false;
                        if (nice) {
            ...
            function mplex(el, lst, fn) {
                for (let a = 0; a < lst.length; a++) fn(el, lst[a]);
            };
            ...
            jQuery.fn.getNiceScroll = function(index) {
                if (typeof index == "undefined") {
                    ...
                    const nice = this[index] && $.data(this[index], "__nicescroll") || false;
                    return nice;
                }
            };

...
{
    public class IngredientByFriendlyIdOutput
    {
        ...
        public IEnumerable<CategoriesByIngredientIdOutput> Categories { get; set; }
        public IEnumerable<AllowedQuantitiesByIngredientIdOutput> AllowedQuantities { get; set; }
    }
}
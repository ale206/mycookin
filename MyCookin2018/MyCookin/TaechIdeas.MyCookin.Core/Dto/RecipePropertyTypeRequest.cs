...
namespace TaechIdeas.MyCookin.Core.Dto
{
    public class RecipePropertyTypeRequest
    {
        ...
        [StringLength(100, MinimumLength = 1,
            ErrorMessage = "PropertyType Length must be between 1 and 100 characters")]
        ...
        [StringLength(100, MinimumLength = 1,
            ErrorMessage = "RecipePropertyTypeToolTip Length must be between 1 and 100 characters")]

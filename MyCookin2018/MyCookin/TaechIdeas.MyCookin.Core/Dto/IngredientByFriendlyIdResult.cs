...
{
    public class IngredientByFriendlyIdResult
    {
        ...
        public IEnumerable<CategoriesByIngredientIdResult> Categories { get; set; }
        public IEnumerable<AllowedQuantitiesByIngredientIdResult> AllowedQuantities { get; set; }
    }
}
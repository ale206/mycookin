...
namespace TaechIdeas.MyCookin.Core
{
    ...
    {
        IEnumerable<IngredientLanguageListOutput> IngredientLanguageList(
            IngredientLanguageListInput ingredientLanguageListInput);

        IEnumerable<SearchIngredientByLanguageAndNameOutput> SearchIngredientByLanguageAndName(
            SearchIngredientByLanguageAndNameInput searchIngredientByLanguageAndNameInput);

        IEnumerable<IngredientQuantityTypeListOutput> IngredientQuantityTypeList(
            IngredientQuantityTypeListInput ingredientQuantityTypeListInput);

        GenerateIngredientFriendlyIdOutput GenerateIngredientFriendlyId(
        ...
        IEnumerable<AllowedQuantitiesByIngredientIdOutput> AllowedQuantitiesByIngredientId(
            AllowedQuantitiesByIngredientIdInput allowedQuantitiesByIngredientIdInput);

        IEnumerable<CategoriesByIngredientIdOutput> CategoriesByIngredientId(
        ...
        InsertIngredientLanguageOutput InsertIngredientLanguage(
            InsertIngredientLanguageInput insertIngredientLanguageInput);

        UpdateIngredientLanguageOutput UpdateIngredientLanguage(
        ...
        QuantityNotStdByIdAndLanguageOutput QuantityNotStdByIdAndLanguage(
            QuantityNotStdByIdAndLanguageInput quantityNotStdByIdAndLanguageInput);

        IngredientQuantityTypeLanguageOutput IngredientQuantityTypeLanguage(
            IngredientQuantityTypeLanguageInput ingredientQuantityTypeLanguageInput);

        IEnumerable<IngredientsByIdRecipeAndLanguageOutput> IngredientsByIdRecipeAndLanguage(
            IngredientsByIdRecipeAndLanguageInput ingredientsByIdRecipeAndLanguageInput);

        IEnumerable<IngredientsByIdRecipeAndLanguageOutput> AddQuantityTypeLanguage(
            IEnumerable<IngredientsByIdRecipeAndLanguageOutput> recipeIngredientDetailsLanguageMapped);

        string CalculateQuantityTypeLanguage(
            IngredientsByIdRecipeAndLanguageOutput ingredientsesByIdRecipeAndLanguageOutput);

        IEnumerable<IngredientsByIdRecipeAndLanguageOutput> AddCalculatedIngredient(
            IEnumerable<IngredientsByIdRecipeAndLanguageOutput> recipeIngredientDetailsLanguageMapped);

        string GetCalculatedIngredient(IngredientsByIdRecipeAndLanguageOutput andLanguageOutput);

        IEnumerable<IngredientsByIdRecipeOutput> IngredientsByIdRecipe(
            IngredientsByIdRecipeInput ingredientsByIdRecipeInput);

        TranslateBunchOfIngredientsOutput TranslateBunchOfIngredients(
        ...
        //BEVERAGES
        /****************************************************************/
        IEnumerable<SearchBeverageByLanguageOutput> SearchBeverageByLanguage(
        ...
        IEnumerable<SuggestedBeverageByRecipeOutput> SuggestedBeverageByRecipe(

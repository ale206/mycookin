...
namespace TaechIdeas.MyCookin.BusinessLogic
{
    public class RecipeVoteManager : IRecipeVoteManager
    {
        ...
        {
            return _mapper.Map<RecipeVoteOutput>(
                _recipeRepository.RecipeVote(_mapper.Map<RecipeVoteIn>(recipeVoteInput)));
        }
        ...
        {
            return _mapper.Map<RecipeAvgVoteOutput>(
                _recipeRepository.RecipeAvgVote(_mapper.Map<RecipeAvgVoteIn>(recipeAvgVoteInput)));
        }
        ...
        {
            return _mapper.Map<DeleteVoteOutput>(
                _recipeRepository.DeleteVote(_mapper.Map<DeleteVoteIn>(deleteVoteInput)));
        }

...
namespace TaechIdeas.MyCookin.API.Controllers
{
    ...
    public class IngredientController : ControllerBase
    {
        ...
        public IEnumerable<IngredientLanguageListResult> IngredientLanguageList(
            IngredientLanguageListRequest ingredientLanguageListRequest)
        {
            return _mapper.Map<IEnumerable<IngredientLanguageListResult>>(
                _ingredientManager.IngredientLanguageList(
                    _mapper.Map<IngredientLanguageListInput>(ingredientLanguageListRequest)));
        }
        ...
        public IEnumerable<SearchIngredientByLanguageAndNameResult> IngredientByIngredientName(string ingredientName,
            int languageId)
        {
            ...
            return _mapper.Map<IEnumerable<SearchIngredientByLanguageAndNameResult>>(
                _ingredientManager.SearchIngredientByLanguageAndName(searchIngredientByLanguageAndNameInput));
        }
        ...
        public IEnumerable<IngredientQuantityTypeListResult> IngredientQuantityTypeList(int languageId)
        {
            ...
            return _mapper.Map<IEnumerable<IngredientQuantityTypeListResult>>(
                _ingredientManager.IngredientQuantityTypeList(ingredientQuantityTypeListInput));
        }
        ...
        public IngredientByFriendlyIdResult IngredientByFriendlyId(string friendlyId)
        {
            ...
            return _mapper.Map<IngredientByFriendlyIdResult>(
                _ingredientManager.IngredientByFriendlyId(ingredientByFriendlyIdInput));
        }
        ...
        public IEnumerable<AllowedQuantitiesByIngredientIdResult> AllowedQuantitiesByIngredientId(Guid ingredientId,
            int languageId)
        {
            var allowedQuantitiesByIngredientIdInput = new AllowedQuantitiesByIngredientIdInput
                {IngredientId = ingredientId, LanguageId = languageId};
            return _mapper.Map<IEnumerable<AllowedQuantitiesByIngredientIdResult>>(
                _ingredientManager.AllowedQuantitiesByIngredientId(allowedQuantitiesByIngredientIdInput));
        }
        ...
        public IEnumerable<CategoriesByIngredientIdResult> CategoriesByIngredientId(Guid ingredientId, int languageId)
        {
            var categoriesByIngredientIdInput = new CategoriesByIngredientIdInput
                {IngredientId = ingredientId, LanguageId = languageId};
            return _mapper.Map<IEnumerable<CategoriesByIngredientIdResult>>(
                _ingredientManager.CategoriesByIngredientId(categoriesByIngredientIdInput));
        }
        ...
        {
            return _mapper.Map<InsertIngredientResult>(
                _ingredientManager.InsertIngredient(_mapper.Map<InsertIngredientInput>(insertIngredientRequest)));
        }
        ...
        {
            return _mapper.Map<UpdateIngredientResult>(
                _ingredientManager.UpdateIngredient(_mapper.Map<UpdateIngredientInput>(updateIngredientRequest)));
        }
        ...
        public InsertIngredientLanguageResult InsertIngredientLanguage(
            InsertIngredientLanguageRequest insertIngredientLanguageRequest)
        {
            return _mapper.Map<InsertIngredientLanguageResult>(
                _ingredientManager.InsertIngredientLanguage(
                    _mapper.Map<InsertIngredientLanguageInput>(insertIngredientLanguageRequest)));
        }
        ...
        public UpdateIngredientLanguageResult UpdateIngredientLanguage(
            UpdateIngredientLanguageRequest updateIngredientLanguageRequest)
        {
            return _mapper.Map<UpdateIngredientLanguageResult>(
                _ingredientManager.UpdateIngredientLanguage(
                    _mapper.Map<UpdateIngredientLanguageInput>(updateIngredientLanguageRequest)));
        }
        ...
        {
            return _mapper.Map<DeleteIngredientResult>(
                _ingredientManager.DeleteIngredient(_mapper.Map<DeleteIngredientInput>(deleteIngredientRequest)));
        }
        ...
        public TranslateBunchOfIngredientsResult TranslateBunchOfIngredients(
            TranslateBunchOfIngredientsRequest translateBunchOfIngredientsRequest)
        {
            return _mapper.Map<TranslateBunchOfIngredientsResult>(
                _ingredientManager.TranslateBunchOfIngredients(
                    _mapper.Map<TranslateBunchOfIngredientsInput>(translateBunchOfIngredientsRequest)));
        }
        ...
        public IEnumerable<SearchBeverageByLanguageResult> SearchBeverageByLanguage(string beverageName, int languageId)
        {
            return
                _mapper.Map<IEnumerable<SearchBeverageByLanguageResult>>(
                    _ingredientManager.SearchBeverageByLanguage(new SearchBeverageByLanguageInput
                        {LanguageId = languageId, BeverageName = beverageName}));
        }
        ...
        {
            return _mapper.Map<AddRecipeBeverageResult>(
                _ingredientManager.AddRecipeBeverage(_mapper.Map<AddRecipeBeverageInput>(addRecipeBeverageRequest)));
        }
        ...
        {
            return _mapper.Map<DeleteRecipeBeverageResult>(
                _ingredientManager.DeleteRecipeBeverage(
                    _mapper.Map<DeleteRecipeBeverageInput>(deleteRecipeBeverageRequest)));
        }
        ...
        {
            return _mapper.Map<IEnumerable<SuggestedBeverageByRecipeResult>>(
                _ingredientManager.SuggestedBeverageByRecipe(new SuggestedBeverageByRecipeInput {RecipeId = recipeId}));
        }
    }
}
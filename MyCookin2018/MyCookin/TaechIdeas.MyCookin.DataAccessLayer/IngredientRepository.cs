...
namespace TaechIdeas.MyCookin.DataAccessLayer
{
    public class IngredientRepository : IIngredientRepository
    {
        ...
        public IEnumerable<IngredientLanguageListOut> IngredientLanguageList(
            IngredientLanguageListIn ingredientLanguageListIn)
        {
        ...
        public IEnumerable<SearchIngredientByLanguageAndNameOut> SearchIngredientByLanguageAndName(
            SearchIngredientByLanguageAndNameIn searchIngredientByLanguageAndNameIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<SearchIngredientByLanguageAndNameOut>>(
                    "USP_SearchIngredientByLanguageAndName",
                    new
                    {
        ...
        public IEnumerable<IngredientQuantityTypeListOut> IngredientQuantityTypeList(
            IngredientQuantityTypeListIn ingredientQuantityTypeListIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<IngredientQuantityTypeListOut>>(
                    "USP_GetIngredientQuantityTypeList",
                    new
                    {
        ...
        public IEnumerable<IngredientModifiedByUserOut> IngredientModifiedByUser(
            IngredientModifiedByUserIn ingredientModifiedByUserIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<IngredientModifiedByUserOut>>(
                    "USP_IngredientModifiedByUser",
                    commandType: CommandType.StoredProcedure
                );
            }
        ...
        public GenerateIngredientFriendlyIdOut GenerateFriendlyId(
        ...
        public GenerateAllIngredientFriendlyIdOut GenerateAllIngredientFriendlyId()
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<GenerateAllIngredientFriendlyIdOut>(
                    "USP_GenerateAllIngredientFriendlyId",
                    commandType: CommandType.StoredProcedure
                );
            }
        ...
        public IEnumerable<CategoriesByIngredientIdOut> CategoriesByIngredientId(
            CategoriesByIngredientIdIn categoriesByIngredientIdIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<CategoriesByIngredientIdOut>>(
                    "USP_CategoriesByIngredientId",
                    new
                    {
        ...
        public IEnumerable<AllowedQuantitiesByIngredientIdOut> AllowedQuantitiesByIngredientId(
            AllowedQuantitiesByIngredientIdIn allowedQuantitiesByIngredientIdIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<AllowedQuantitiesByIngredientIdOut>>(
                    "USP_AllowedQuantitiesByIngredientId",
                    new
                    {
        ...
        public InsertIngredientLanguageOut InsertIngredientLanguage(
            InsertIngredientLanguageIn insertIngredientLanguageIn)
        {
        ...
        public UpdateIngredientLanguageOut UpdateIngredientLanguage(
            UpdateIngredientLanguageIn updateIngredientLanguageIn)
        {
        ...
        public IngredientQuantityTypeLanguageOut IngredientQuantityTypeLanguage(
            IngredientQuantityTypeLanguageIn ingredientQuantityTypeLanguageIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IngredientQuantityTypeLanguageOut>(
                    "USP_GetIngredientsQuantityTypesLangByID",
                    new
                    {
        ...
        public QuantityNotStdByIdAndLanguageOut QuantityNotStdByIdAndLanguage(
            QuantityNotStdByIdAndLanguageIn quantityNotStdByIdAndLanguageIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<QuantityNotStdByIdAndLanguageOut>(
                    "USP_GetQuantityNotStdByIdAndLanguage",
                    new
                    {
        ...
        public IEnumerable<IngredientsByIdRecipeAndLanguageOut> IngredientsByIdRecipeAndLanguage(
            IngredientsByIdRecipeAndLanguageIn ingredientsByIdRecipeAndLanguageIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<IngredientsByIdRecipeAndLanguageOut>>(
                    "USP_GetDetailedIngredientsByIdRecipeAndLanguage",
                    new
                    {
        ...
        public IEnumerable<IngredientsByIdRecipeOut> IngredientsByIdRecipe(
            IngredientsByIdRecipeIn ingredientsByIdRecipeIn)
        {
            IEnumerable<IngredientsByIdRecipeOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<IngredientsByIdRecipeOut>>(
                    "USP_GetDetailedIngredientsByIdRecipe",
                    new
                    {
        ...
        public IEnumerable<IngredientsToTranslateOut> IngredientsToTranslate(
            IngredientsToTranslateIn ingredientsToTranslateIn)
        {
            IEnumerable<IngredientsToTranslateOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<IngredientsToTranslateOut>>(
                    "USP_GetIngredientToTranslate",
                    new
                    {
        ...
        public AddNewIngredientTranslationOut AddNewIngredientTranslation(
        ...
        public IEnumerable<SearchBeverageByLanguageOut> SearchBeverageByLanguage(
            SearchBeverageByLanguageIn searchBeverageByLanguageIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<SearchBeverageByLanguageOut>>(
                    "USP_GetBeverageByNameContains",
                    new
                    {
        ...
        public IEnumerable<SuggestedBeverageByRecipeOut> SuggestedBeverageByRecipe(
            SuggestedBeverageByRecipeIn suggestedBeverageByRecipeIn)
        {
            ...
            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<SuggestedBeverageByRecipeOut>>(
                    "USP_SuggestedBeverageByRecipe",
                    new
                    {

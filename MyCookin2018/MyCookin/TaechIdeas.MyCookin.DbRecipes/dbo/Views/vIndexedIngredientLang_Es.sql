...
CREATE VIEW [dbo].[vIndexedIngredientLang_Es]
WITH SCHEMABINDING 
AS
...
WHERE        (dbo.Ingredients.IngredientEnabled = 1) AND (dbo.Languages.IDLanguage = 3)


GO
CREATE UNIQUE CLUSTERED INDEX [IX_IDIngredientLanguage]
    ON [dbo].[vIndexedIngredientLang_Es]([IDIngredientLanguage] ASC);

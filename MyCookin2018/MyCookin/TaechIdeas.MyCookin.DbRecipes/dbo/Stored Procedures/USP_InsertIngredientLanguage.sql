...
-- Description:	<New Ingredient Language>
-- =============================================
CREATE PROCEDURE [dbo].[USP_InsertIngredientLanguage]
...
BEGIN TRY
   	...
   	DECLARE @IDIngredientLanguage uniqueidentifier = NEWID()
	...
	SELECT @IDIngredientLanguage AS IngredientLanguageId

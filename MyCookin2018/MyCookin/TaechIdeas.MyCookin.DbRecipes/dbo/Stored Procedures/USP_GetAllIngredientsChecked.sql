...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetAllIngredientsChecked]
...
BEGIN TRY
        ...
        SELECT     dbo.IngredientsLanguages.IDIngredientLanguage, dbo.IngredientsLanguages.IDIngredient, dbo.IngredientsLanguages.IngredientSingular,

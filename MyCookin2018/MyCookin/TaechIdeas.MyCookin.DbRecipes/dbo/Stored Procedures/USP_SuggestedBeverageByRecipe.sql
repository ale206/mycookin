...
-- =============================================
CREATE PROCEDURE [dbo].[USP_SuggestedBeverageByRecipe]
...
BEGIN TRY
        ...
        SELECT	IDBeverageRecipe, IDRecipe, IDBeverage, IDUserSuggestedBy, DateSuggestion, BeverageRecipeAvgRating 
		FROM	BeveragesRecipes
        WHERE	IDRecipe = @IDRecipe
        ORDER BY BeverageRecipeAvgRating DESC

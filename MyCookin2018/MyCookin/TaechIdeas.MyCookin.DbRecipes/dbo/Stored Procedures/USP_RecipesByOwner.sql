...
-- Description:	<>
-- =============================================
CREATE PROCEDURE [dbo].[USP_RecipesByOwner]	
...
BEGIN TRY
   SELECT IDRecipeLanguage, Recipes.IDRecipe, RecipeName FROM Recipes INNER JOIN RecipesLanguages
                      ON Recipes.IDRecipe = RecipesLanguages.IDRecipe
                      WHERE IDOwner = @IDOwner AND (DeletedOn is null)
                      ORDER BY RecipeName

    ...
    Timepicker.prototype = {
        ...
        getTemplate: function() {
            ...
            templateContent =
                ...
                this.showSeconds ? `<td class="separator">:</td><td>${secondTemplate}</td>` : ""}${this.showMeridian
            ...
            case "modal":
                template =
                    `<div class="bootstrap-timepicker-widget modal hide fade in" data-backdrop="${this.modalBackdrop
                    ? "true"
                    : "false"
        ...
        updateWidget: function() {
            ...
            const minute = this.minute.toString().length === 1 ? `0${this.minute}` : this.minute;
            const second = this.second.toString().length === 1 ? `0${this.second}` : this.second;
        ...
        updateFromWidgetInputs: function() {
            ...
            const t = this.$widget.find("input.bootstrap-timepicker-hour").val() +
                ":" +
        ...
        widgetKeydown: function(e) {
            const $input = $(e.target);
            const name = $input.attr("class").replace("bootstrap-timepicker-", "");

 ...
 */
        ...
        var NotyObject = {
            ...
            _build: function() {
                ...
                // Generating noty bar
                const $bar = $(`<div class="noty_bar noty_type_${this.options.type}"></div>`)
                ...
                if (this.options.themeClassName)
                    this.$bar.addClass(this.options.themeClassName)
                ...
                if (this.options.buttons) {
                    ...
                    const $buttons = $("<div/>").addClass("noty_buttons");
                    ...
                    $.each(this.options.buttons,
                        function(i, button) {
                            var $button = $("<button/>").addClass((button.addClass) ? button.addClass : "gray")
                                .html(button.text).attr("id", button.id ? button.id : `button-${i}`)
            ...
            show: function() {
                ...
                if (typeof self.options.animation.open == "string") {
                    ...
                    self.$bar.show().addClass(self.options.animation.open).one(
            ...
            close: function() {
                ...
                if (typeof self.options.animation.close == "string") {
                    self.$bar.addClass(self.options.animation.close).one(
                        "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                        function() {
            ...
            closeCleanUp: function() {
                ...
                if (typeof self.$bar !== "undefined" && self.$bar !== null) {
                    ...
                    if (typeof self.options.animation.close == "string") {
                        ...
                        self.$bar.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
                            function() {
                                self.$bar.remove();
                                self.$bar = null;
                                self.closed = true;
        ...
        $.notyRenderer.init = function(options) {
            ...
            const notification = Object.create(NotyObject).init(options);
        ...
        $.notyRenderer.render = function() {
            ...
            const instance = $.noty.queue[0];

            if ($.type(instance) === "object") {
                if (instance.options.dismissQueue) {
                    if (instance.options.maxVisible > 0) {
                        if ($(instance.options.layout.container.selector + " > li").length <
        ...
        $.notyRenderer.show = function(notification) {
            ...
            if (notification.options.custom) {
                if (notification.options.custom.find(notification.options.layout.container.selector).length == 0) {
                    ...
                    notification.options.custom.find(notification.options.layout.container.selector)
        ...
        $.notyRenderer.createModalFor = function(notification) {
            if ($(".noty_modal").length == 0) {
                const modal = $("<div/>").addClass("noty_modal").addClass(notification.options.theme)
        ...
        $.notyRenderer.setLayoutCountFor = function(notification, arg) {
            return $(notification.options.layout.container.selector).data("noty_layout_count",
        ...
        $.noty.layouts.center = {
            ...
            container: {
                ...
                style: function() {
                    ...
                    const dupe = $(this).clone()
                        .css({ visibility: "hidden", display: "block", position: "absolute", top: 0, left: 0 })
                        .attr("id", "dupe");
                    $("body").append(dupe);
                    dupe.find(".i-am-closing-now").remove();
                    dupe.find("li").css("display", "block");
                    const actual_height = dupe.height();
                    dupe.remove();
            ...
            helpers: {
                borderFix: function() {
                    if (this.options.dismissQueue) {
                        const selector = this.options.layout.container.selector +
                            " " +

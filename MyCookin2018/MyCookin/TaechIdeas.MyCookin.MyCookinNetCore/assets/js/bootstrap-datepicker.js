...
(function($, undefined) {
    ...
    Datepicker.prototype = {
        ...
        fill: function() {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                html.push(
                    `<td class="${clsName.join(" ")}"${tooltip ? ` title="${tooltip}"` : ""}>${prevMonth.getUTCDate()
                    }</td>`);
    ...
    DPGlobal.template =
        `<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">${DPGlobal.headTemplate
        }<tbody></tbody>${DPGlobal.footTemplate
        }</table></div><div class="datepicker-months"><table class="table-condensed">${DPGlobal.headTemplate}${
        DPGlobal.contTemplate}${DPGlobal.footTemplate
        }</table></div><div class="datepicker-years"><table class="table-condensed">${DPGlobal.headTemplate}${
        DPGlobal.contTemplate}${DPGlobal.footTemplate}</table></div></div>`;

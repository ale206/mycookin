...
namespace TaechIdeas.MyCookin.IntegrationTests.Recipe
{
    public class RecipesInHomePageTests
    {
        ...
        public void TopRecipesByLanguage_Success(int languageId, bool includeIngredients, bool includeSteps,
        ...
        [InlineData(3, false, true, true)]
        [InlineData(3, false, false, true)]
        public void BestRecipesByLanguage_Success(int languageId, bool includeIngredients, bool includeSteps,
            bool includeProperties)
        {
        ...
        public void SearchRecipesWithoutEmptyFridge_Success(int languageId, bool glutenFree, bool vegan,
            bool vegetarian, bool light, bool quick)
        {
        ...
        [InlineData(3, true, true, true, true, false)]
        [InlineData(3, true, true, true, true, true)]
        public void SearchRecipesWithEmptyFridge_Success(int languageId, bool glutenFree, bool vegan, bool vegetarian,
            bool light, bool quick)
        {

...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetTemplateAccordingToTypeAndLanguage]
...
BEGIN TRY
                      ...
                      SELECT        UserActionTypeTemplate, UserActionTypeTemplatePlural, NotificationTemplate
                      FROM          UserActionsTypesLanguages
                      WHERE        (IDUserActionType = @IDUserActionType) AND (IDLanguage = @IDLanguage)

...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetObjectYouLike]
...
BEGIN TRY
                      ...
                      SELECT IDUser AS IDUserOwner, IDUserActionType, IDActionRelatedObject
                      FROM UsersActions WHERE IDUserAction = @IDUserActionFather AND DeletedOn IS NULL

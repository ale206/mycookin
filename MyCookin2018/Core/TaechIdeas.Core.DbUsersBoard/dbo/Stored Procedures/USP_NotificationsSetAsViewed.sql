...
-- Description:	<Set User Notifications As Viewed,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_NotificationsSetAsViewed]
...
BEGIN TRY
	...
	UPDATE UsersNotifications 
		...
		AND ViewedOn IS NULL

SET @ResultExecutionCode = ' ' -- Set User Notifications As Notified
	SET @USPReturnValue = @IDUserOwnerRelatedObject --ID OF THE NOTIFICATION
	SET @isError = 0

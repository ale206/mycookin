...
BEGIN TRY
           ...
           DELETE FROM [dbo].[UsersActions] WHERE IDUserActionFather = @IDUserActionFather 
		   AND IDUser = @IDUser AND IDUserActionType = @IDUserActionType
                   
			SELECT 1 AS LikeDeleted 

...
-- Last Edit:   <,,>
-- Description:	<Set User Notifications As Notified,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_NotificationsSetAsNotified]
	@IDUserNotification uniqueidentifier
...
BEGIN TRY
	...
	UPDATE UsersNotifications 
		SET NotifiedOn = GETUTCDATE() 
		WHERE IDUserNotification = @IDUserNotification
		AND NotifiedOn IS NULL

	
	SET @ResultExecutionCode = ' ' -- Set User Notifications As Notified

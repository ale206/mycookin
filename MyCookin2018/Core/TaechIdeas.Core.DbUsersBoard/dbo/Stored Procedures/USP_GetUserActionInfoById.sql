...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetUserActionInfoById]
...
SELECT IDUserAction, IDUser, IDUserActionFather, IDUserActionType, IDActionRelatedObject, UserActionMessage, IDVisibility, 
UserActionDate, DeletedOn FROM dbo.UsersActions 

...
-- ================================================
-- =============================================
-- Author:		<Federcio Tasso>
-- Create date: <06/02/2016,,>
-- Last Edit:   <,,>
-- Description:	<Check if shared,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_CheckIfShared]
...
BEGIN TRY
	...
	SELECT COUNT(1) AS NumberUserActionsShared FROM UserActionsShared WHERE IDUserAction = @IDUserAction AND IDUser = @IDUser 

...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_DeleteUserAction]
...
BEGIN TRY
           ...
           UPDATE [dbo].[UsersActions] SET DeletedOn = GETUTCDATE() WHERE IDUserAction = @IDUserAction

		   SELECT 1 AS UserActionDeleted

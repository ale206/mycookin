...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_CheckIfSharedOnPersonalBoard]
...
BEGIN TRY
        ...
        SELECT COUNT(1) AS UsersActions FROM UsersActions
        WHERE IDActionRelatedObject = @IDActionRelatedObject AND IDUserActionType = @IDUserActionType AND IDUser = @IDUser

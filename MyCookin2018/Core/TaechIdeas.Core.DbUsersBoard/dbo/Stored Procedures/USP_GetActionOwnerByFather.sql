...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetActionOwnerByFather]
...
BEGIN TRY
        ...
        SELECT IDUserAction, IDUser, IDUserActionFather, IDUserActionType, IDActionRelatedObject, UserActionMessage, 
		IDVisibility, UserActionDate, DeletedOn FROM dbo.UsersActions WHERE IDUserAction = @IDUserActionFather

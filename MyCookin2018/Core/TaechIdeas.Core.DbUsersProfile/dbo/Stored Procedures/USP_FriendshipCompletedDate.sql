...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_FriendshipCompletedDate]
...
BEGIN TRY
                      ...
                      SELECT     FriendshipCompletedDate
                      FROM         UsersFriends
                      WHERE     (IDUser1 = @IDUser1) AND (IDUser2 = @IDUser2) AND (FriendshipCompletedDate IS NOT NULL)

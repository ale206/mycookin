...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_FriendshipRequests]
...
BEGIN TRY
                      ...
                      SELECT     FriendshipCompletedDate, IDUser1 AS IDUserRequest, IDUser2 AS Me, IDUserFriend, UserBlocked
                      FROM         UsersFriends
                      WHERE     (IDUser2 = @IDUser) AND (IDUser1 <> @IDUser) AND (FriendshipCompletedDate IS NULL) AND (UserBlocked IS NULL)

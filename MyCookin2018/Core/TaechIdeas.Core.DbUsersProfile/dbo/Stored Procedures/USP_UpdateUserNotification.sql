...
-- Last Edit:   <,,>
-- Description:	<Update Notification Setting of a User,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UpdateUserNotification]
...
BEGIN TRY
	...
	UPDATE UsersNotifications SET IsEnabled = @IsEnabled WHERE IDUserNotification = @IDUserNotification

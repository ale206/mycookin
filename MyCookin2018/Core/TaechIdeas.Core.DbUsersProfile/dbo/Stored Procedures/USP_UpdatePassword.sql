...
BEGIN TRY
	...
	UPDATE [dbo].[Users] SET [PasswordHash] = @PasswordHash, [LastPasswordChange] = @LastPasswordChange, 
	[PasswordExpireOn] = @PasswordExpireOn WHERE (IDUser = @IDUser)

	SELECT 1 AS PasswordUpdated

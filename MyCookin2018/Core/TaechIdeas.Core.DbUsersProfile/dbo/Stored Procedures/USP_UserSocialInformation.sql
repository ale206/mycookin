...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UserSocialInformation]
...
BEGIN TRY
	...
	SELECT IDSocialLogin, IDSocialNetwork, IDUserSocial, Link, VerifiedEmail, PictureUrl, Locale, AccessToken, FriendsRetrievedOn, RefreshToken FROM dbo.SocialLogins WHERE IDUser = @IDUser AND IDSocialNetwork = @IDSocialNetwork

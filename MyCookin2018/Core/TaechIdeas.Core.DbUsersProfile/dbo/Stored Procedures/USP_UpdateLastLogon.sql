...
-- Last Edit:   <,,>
-- Description:	<Update LastLogon of a user,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UpdateLastLogon]
...
BEGIN TRY
   BEGIN TRANSACTION    -- CHECK IF THE USER HAS ALREADY A TOKEN
		...
		UPDATE Users SET LastLogon = GETUTCDATE(), UserIsOnLine = 1 WHERE IDUser = @IDUser

			SET @ResultExecutionCode = 'US-IN-0000' --OK

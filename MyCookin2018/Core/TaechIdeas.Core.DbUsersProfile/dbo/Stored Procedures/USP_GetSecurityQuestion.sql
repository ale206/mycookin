...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetSecurityQuestion]
...
BEGIN TRY
                      ...
                      SELECT        SecurityQuestionsLanguages.SecurityQuestion  AS SecurityQuestion, IDSecurityQuestionLanguage, SecurityQuestionsLanguages.IDSecurityQuestion, SecurityQuestionsLanguages.IDLanguage

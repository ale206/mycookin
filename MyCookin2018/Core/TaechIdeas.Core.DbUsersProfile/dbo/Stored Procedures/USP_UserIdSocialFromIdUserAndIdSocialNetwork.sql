...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UserIdSocialFromIdUserAndIdSocialNetwork]
...
BEGIN TRY
	...
	SELECT IDUserSocial FROM dbo.SocialLogins WHERE IDUser = @IDUser AND IDSocialNetwork = @IDSocialNetwork

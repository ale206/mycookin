...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UpdateTemporarySecurityAnswer]
	@IDUser uniqueidentifier,
	@SecurityAnswer nvarchar(150)
...
BEGIN TRY
	...
	UPDATE [dbo].[Users] SET [SecurityAnswer] = @SecurityAnswer WHERE (IDUser = @IDUser)

	SELECT 1 AS TemporarySecurityAnswerUpdated
...
SELECT 0 AS TemporarySecurityAnswerUpdated

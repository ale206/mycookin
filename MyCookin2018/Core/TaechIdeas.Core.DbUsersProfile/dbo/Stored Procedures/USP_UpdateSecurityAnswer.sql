...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UpdateSecurityAnswer]
	@IDUser uniqueidentifier,
	@SecurityAnswer uniqueidentifier,
...
BEGIN TRY
	...
	UPDATE [dbo].[Users] SET [IDSecurityQuestion] = @IDSecurityQuestion, [SecurityAnswer] = @SecurityAnswer WHERE (IDUser = @IDUser)

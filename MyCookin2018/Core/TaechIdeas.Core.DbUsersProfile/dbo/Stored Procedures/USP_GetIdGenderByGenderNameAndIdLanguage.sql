...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetIdGenderByGenderNameAndIdLanguage]
	@Gender nvarchar(100),
	@IDLanguage int
...
BEGIN TRY
	...
	SELECT IDGender AS GenderId FROM dbo.Gender WHERE Gender = @Gender AND IDLanguage = @IDLanguage

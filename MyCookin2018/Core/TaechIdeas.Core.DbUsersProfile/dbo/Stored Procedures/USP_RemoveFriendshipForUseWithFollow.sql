...
-- Last Edit:   <,,>
-- Description:	<Remove Friendship just for One Direction. If we are friend and you don't want to be myfriend, when you delete me for me you will be always my friend.>
-- =============================================
CREATE PROCEDURE [dbo].[USP_RemoveFriendshipForUseWithFollow]
   ...
   --CHECK EXISTENCE USER1, USER2
	IF EXISTS (SELECT IDUserFriend FROM dbo.UsersFriends WHERE IDUser1 = @IDUser1 AND IDUser2 = @IDUser2)
		BEGIN
			...
			UPDATE dbo.UsersFriends SET FriendshipCompletedDate = NULL WHERE IDUser2 = @IDUser1 AND IDUser1 = @IDUser2

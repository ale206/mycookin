...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_UsersIdWithOldFriendsRetrievedOn]
	@FriendsRetrievedOn smalldatetime		
AS
...
BEGIN TRY
	...
	SELECT IDUser, IDSocialNetwork FROM dbo.SocialLogins WHERE FriendsRetrievedOn < @FriendsRetrievedOn OR FriendsRetrievedOn IS NULL

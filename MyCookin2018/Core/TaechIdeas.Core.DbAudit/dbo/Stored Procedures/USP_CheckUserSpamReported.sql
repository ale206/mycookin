...
-- Description:	<,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_CheckUserSpamReported]
...
BEGIN TRY
	SELECT IDAuditEvent, AuditEventMessage, ObjectID, ObjectType, ObjectTxtInfo, AuditEventLevel, EventInsertedOn, EventUpdatedOn, 
	IDEventUpdatedBy, AuditEventIsOpen 
	FROM dbo.AuditEvent

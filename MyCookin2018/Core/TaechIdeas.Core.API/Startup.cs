...
using TaechIdeas.Core.API.Middleware;
using TaechIdeas.Core.API.Utils;
using TaechIdeas.Core.IoC;
using TaechIdeas.Core.IoC.AutoMapper;

namespace TaechIdeas.Core.API
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            TypeDescriptor.AddAttributes(typeof(DateTime), new TypeConverterAttribute(typeof(DateUtils.UtcDateTimeConverter)));
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info {Title = "TaechIdeas Core API", Version = "v1"});

                // To enable multiple versions:
                // https://dannyvanderkraan.wordpress.com/2016/09/09/asp-net-core-1-0-web-api-automatic-documentation-with-swagger-and-swashbuckle/
                ...
                xmlPath = Path.Combine(AppContext.BaseDirectory, "TaechIdeas.Core.Core.xml"); // Keep this in sync with csproj's <DocumentationFile>
                c.IncludeXmlComments(xmlPath);
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            ...
            // Swagger
            app.UseSwagger(c => { c.RouteTemplate = "{documentName}/swagger/swagger.json"; });
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/v1/swagger/swagger.json", "TaechIdeas Core API");

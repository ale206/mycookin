...
using RestSharp;
using TaechIdeas.Core.BusinessLogic.Audit;
using TaechIdeas.Core.DataAccessLayer;
using TaechIdeas.Core.IoC.AutoMapper;
using TaechIdeas.Core.Services;

namespace TaechIdeas.Core.IoC
{
    public static class Setup
    {
        ...
        private static void RegisterAllTypes(this IServiceCollection serviceCollection)
        {
            ...
            {
                // Business Logic
                typeof(AuditManager).GetTypeInfo().Assembly,

...
-- =============================================
CREATE PROCEDURE [dbo].[USP_MessageSetAsDeleted]
	@IDMessageRecipient uniqueidentifier
...
BEGIN TRY
	...
	UPDATE MessagesRecipients
		...
		WHERE IDMessageRecipient = @IDMessageRecipient
		AND DeletedOn IS NULL

	
	SET @ResultExecutionCode = ' '				-- Set Message As Deleted
	SET @USPReturnValue = @IDMessageRecipient	--ID OF MessageRecipient
	SET @isError = 0

...
-- Description:	<Delete error from db table>
-- =============================================
CREATE PROCEDURE [dbo].[USP_DeleteErrorByErrorMessage]
	 
	@ErrorMessageToDelete nvarchar(500)
...
BEGIN TRY
	DELETE FROM ErrorsLogs WHERE ErrorMessage = @ErrorMessageToDelete

	SELECT 1 AS ErrorDeleted

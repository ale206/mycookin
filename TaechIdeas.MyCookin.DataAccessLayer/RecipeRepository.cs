...
namespace TaechIdeas.MyCookin.DataAccessLayer
{
    public class RecipeRepository : IRecipeRepository
    {
        ...
        public IEnumerable<SearchRecipesWithEmptyFridgeOut> SearchRecipesWithEmptyFridge(SearchRecipesWithEmptyFridgeIn searchRecipesWithEmptyFridgeIn)
        {
            IEnumerable<SearchRecipesWithEmptyFridgeOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<SearchRecipesWithEmptyFridgeOut>>("USP_SearchRecipesWithEmptyFridge",
                    new
                    {
        ...
        public IEnumerable<StepsByIdRecipeAndLanguageOut> StepsByIdRecipeAndLanguage(StepsByIdRecipeAndLanguageIn stepsByIdRecipeAndLanguageIn)
        {
        ...
        public IEnumerable<RecipePropertyByIdRecipeAndLanguageOut> RecipePropertyByIdRecipeAndLanguage(RecipePropertyByIdRecipeAndLanguageIn recipePropertyByIdRecipeAndLanguageIn)
        {
            IEnumerable<RecipePropertyByIdRecipeAndLanguageOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<RecipePropertyByIdRecipeAndLanguageOut>>("USP_GetRecipePropertyByIdRecipeAndLanguage",
                    new
                    {
        ...
        public IEnumerable<RecipePropertyByRecipeIdOut> RecipePropertyByRecipeId(RecipePropertyByRecipeIdIn recipePropertyByRecipeIdIn)
        {
            IEnumerable<RecipePropertyByRecipeIdOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<RecipePropertyByRecipeIdOut>>("USP_GetRecipePropertyByIdRecipe",
                    new
                    {
        ...
        public IEnumerable<BestRecipesByLanguageOut> BestRecipesByLanguage(BestRecipesByLanguageIn bestRecipesByLanguageIn)
        {
        ...
        public FriendlyIdByRecipeLanguageIdOut FriendlyIdByRecipeLanguageId(FriendlyIdByRecipeLanguageIdIn friendlyIdByRecipeLanguageIdIn)
        {
        ...
        public UpdateRecipeLanguageStepOut UpdateRecipeLanguageStep(UpdateRecipeLanguageStepIn updateRecipeLanguageStepIn)
        {
        ...
        public AddNewIngredientToRecipeOut AddNewIngredientToRecipe(AddNewIngredientToRecipeIn addNewIngredientToRecipeIn)
        {
        ...
        public CalculateNutritionalFactsOut CalculateNutritionalFacts(CalculateNutritionalFactsIn calculateNutritionalFactsIn)
        {
            CalculateNutritionalFactsOut result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<CalculateNutritionalFactsOut>("USP_CalculateRecipeNutritionalFacts_withTableDirectUpdate",
                    new
                    {
        ...
        public IEnumerable<PropertiesListByTypeAndLanguageOut> PropertiesListByTypeAndLanguage(PropertiesListByTypeAndLanguageIn propertiesListByTypeAndLanguageIn)
        {
            IEnumerable<PropertiesListByTypeAndLanguageOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<PropertiesListByTypeAndLanguageOut>>("USP_GetPropertiesListByTypeAndLanguage",
                    new
                    {
        ...
        public IEnumerable<PropertiesListByTypeLanguageAndRecipeOut> PropertiesListByTypeLanguageAndRecipe(PropertiesListByTypeLanguageAndRecipeIn propertiesListByTypeLanguageAndRecipeIn)
        {
            IEnumerable<PropertiesListByTypeLanguageAndRecipeOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<PropertiesListByTypeLanguageAndRecipeOut>>("USP_GetPropertiesListByTypeLanguageAndRecipe",
                    new
                    {
        ...
        public AddOrUpdatePropertyValueOut AddOrUpdatePropertyValue(AddOrUpdatePropertyValueIn addOrUpdatePropertyValueIn)
        {
        ...
        public IEnumerable<TagsByRecipeAndLanguageOut> TagsByRecipeAndLanguage(TagsByRecipeAndLanguageIn recipeAndLanguageIn)
        {
            IEnumerable<TagsByRecipeAndLanguageOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<TagsByRecipeAndLanguageOut>>("USP_TagsByRecipeAndLanguage",
                    new
                    {
        ...
        public IEnumerable<PropertiesByRecipeAndLanguageOut> PropertiesByRecipeAndLanguage(PropertiesByRecipeAndLanguageIn propertiesByRecipeAndLanguageIn)
        {
            IEnumerable<PropertiesByRecipeAndLanguageOut> result;

            using (var connection = _dbConnectionFactory.GetConnection(_connectionString))
            {
                result = connection.ExecuteScalar<IEnumerable<PropertiesByRecipeAndLanguageOut>>("USP_PropertiesByRecipeAndLanguage",
                    new
                    {
        ...
        public NumberOfRecipesInsertedByUserOut NumberOfRecipesInsertedByUser(NumberOfRecipesInsertedByUserIn numberOfRecipesInsertedByUserIn)
        {

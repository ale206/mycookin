    ...
    angular.module("facebook", []).
                                        ...
                                        var d = $q.defer(),
                                            args =
                                                Array.prototype.slice
                                                    .call(arguments), // Converts arguments passed into an array
                                            userFn,
                                            userFnIndex;
        ...
        run([
            ...
            function($rootScope, $q, $window, $timeout) {
                ...
                const loadSDK = settings.loadSDK;
                ...
                if (loadSDK) {
                    (function injectScript() {
                        ...
                        document.getElementsByTagName("head")[0]
                            .appendChild(script); // // Fix for IE < 9, and yet supported by lattest browsers
                    })();
                }
            }
        ]);

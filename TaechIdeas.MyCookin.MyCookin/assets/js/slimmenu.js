            ...
            Plugin.prototype = {
                init: function() {
                    var $options = this.options,
                        $menu = this.$elem;
                    const $collapser = `<div class="slimmenu-menu-collapser">${$options.collapserTitle
                        }<div class="slimmenu-collapse-button"><span class="slimmenu-icon-bar"></span><span class="slimmenu-icon-bar"></span><span class="slimmenu-icon-bar"></span></div></div>`;
                    var $menu_collapser;
                ...
                resizeMenu: function(event) {
                    ...
                    const $menu = $(event.data.el);
                    const $menu_collapser = $("body").find(".slimmenu-menu-collapser");
                    ...
                    $menu.find("li").each(function() {
                        if ($(this).has("ul").length) {
                            ...
                            if ($(this).has(".slimmenu-sub-collapser").length) {
                                ...
                                $(this).append(
                                    '<span class="slimmenu-sub-collapser"><i class="fa fa-angle-down"></i></span>');
                            }
                        }

                        $(this).children("ul").hide();
                        $(this).find(".slimmenu-sub-collapser").removeClass("expanded").children("i")
                    ...
                    if ($options.resizeWidth >= $window.width() || $("body").hasClass("touch")) {
                        ...
                        $menu.find("li").has("ul").on("mouseenter",
                                function() {

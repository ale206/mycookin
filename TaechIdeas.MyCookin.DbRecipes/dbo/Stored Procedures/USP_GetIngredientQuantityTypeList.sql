...
-- Last Edit:   <,,>
-- Description:	GetIngredientQuantityTypeList,,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_GetIngredientQuantityTypeList]
    @IDLanguage int
AS
...
BEGIN TRY
  ...
  SELECT IDIngredientQuantityTypeLanguage, IDIngredientQuantityType, IDLanguage, IngredientQuantityTypeSingular, IngredientQuantityTypePlural
  FROM IngredientsQuantityTypesLanguages

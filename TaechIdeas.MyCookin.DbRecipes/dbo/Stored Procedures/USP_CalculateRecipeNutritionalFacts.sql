...
-- =============================================
CREATE PROCEDURE [dbo].[USP_CalculateRecipeNutritionalFacts]
...
DECLARE @CountIngredient INT;
	...
	FOR 
		...
		WHERE     (dbo.Recipes.IDRecipe = @IDRecipe AND IDRecipeIngredientAlternative IS NULL) 
	...
	WHILE (@@FETCH_STATUS <> -1)
		...
		INSERT INTO @NutrictionalInfo VALUES('TotRecipeKcal',@TotRecipeKcal)
		INSERT INTO @NutrictionalInfo VALUES('TotRecipeProteins',@TotRecipeProteins)
		INSERT INTO @NutrictionalInfo VALUES('TotRecipeFats',@TotRecipeFats)
		INSERT INTO @NutrictionalInfo VALUES('TotRecipeCarbohydrates',@TotRecipeCarbohydrates)
		INSERT INTO @NutrictionalInfo VALUES('TotRecipeAlcohol',@TotRecipeAlcohol)	
		INSERT INTO @NutrictionalInfo VALUES('TotPercKalFromFat',@TotPercKalFromFat)
		INSERT INTO @NutrictionalInfo VALUES('TotQta',@TotalQta)	 
		
		IF @CountVegetarian = @CountIngredient
			INSERT INTO @NutrictionalInfo VALUES('Vegetarian','true')
		ELSE
			INSERT INTO @NutrictionalInfo VALUES('Vegetarian','false')
		IF @CountVegan = @CountIngredient
			INSERT INTO @NutrictionalInfo VALUES('Vegan','true')
		ELSE
			INSERT INTO @NutrictionalInfo VALUES('Vegan','false')
		IF @CountGlutenFree = @CountIngredient
			INSERT INTO @NutrictionalInfo VALUES('GlutenFree','true')
		ELSE
			INSERT INTO @NutrictionalInfo VALUES('GlutenFree','false')                         
		
		SELECT * FROM @NutrictionalInfo

...
-- Description:	<Description,Cleare Recipe Property Value for a recipe,>
-- =============================================
CREATE PROCEDURE [dbo].[USP_ClearRecipePropertyValue]
...
-- =======================================
  ...
  IF @@TRANCOUNT > 0
	 ...
	 SET @ResultExecutionCode = 'RC-ER-0005' --Error in the StoredProcedure
	 SET @isError = 1

...
-- =============================================
CREATE PROCEDURE [dbo].[USP_DeleteRecipe]
...
BEGIN TRY
   BEGIN TRANSACTION    -- Start the transaction
	...
	UPDATE Recipes SET DeletedOn = GETUTCDATE(), RecipeEnabled = 0 WHERE IDRecipe = @IDRecipe
	
	-- If we reach here, success!
	COMMIT

	SELECT 1 AS RecipeDeleted

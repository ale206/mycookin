<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/SiteStyle/PagesForEmail.Master" AutoEventWireup="true" CodeBehind="NewFriendshipRequest.aspx.cs" Inherits="MyCookinWeb.PagesForEmail.NewFriendshipRequest" %>
    ...
    <asp:Panel ID="pnlEmailMessage" ClientIDMode="Static" runat="server" 
        ...
        <p>
            <asp:Label ID="lblNoReply" runat="server" Text=""
                style="font-size:0.8em; color:#70644F;"></asp:Label>
        <br />
            <asp:Label ID="lblNoMoreEmail" runat="server" Text=""
                style="font-size:0.8em; color:#70644F;"></asp:Label>
        </p>
    </asp:Panel>

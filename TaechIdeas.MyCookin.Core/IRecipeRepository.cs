...
namespace TaechIdeas.MyCookin.Core
{
    public interface IRecipeRepository
    {
        ...
        IEnumerable<SearchRecipesWithEmptyFridgeOut> SearchRecipesWithEmptyFridge(SearchRecipesWithEmptyFridgeIn searchRecipesWithEmptyFridgeIn);
        ...
        IEnumerable<StepsByIdRecipeAndLanguageOut> StepsByIdRecipeAndLanguage(StepsByIdRecipeAndLanguageIn stepsByIdRecipeAndLanguageIn);
        IEnumerable<StepsForRecipeOut> StepsForRecipe(StepsForRecipeIn stepsForRecipeIn);
        IEnumerable<RecipePropertyByIdRecipeAndLanguageOut> RecipePropertyByIdRecipeAndLanguage(RecipePropertyByIdRecipeAndLanguageIn recipePropertyByIdRecipeAndLanguageIn);
        IEnumerable<RecipePropertyByRecipeIdOut> RecipePropertyByRecipeId(RecipePropertyByRecipeIdIn recipePropertyByRecipeIdIn);
        ...
        FriendlyIdByRecipeLanguageIdOut FriendlyIdByRecipeLanguageId(FriendlyIdByRecipeLanguageIdIn friendlyIdByRecipeLanguageIdIn);
        ...
        IEnumerable<PropertiesListByTypeAndLanguageOut> PropertiesListByTypeAndLanguage(PropertiesListByTypeAndLanguageIn propertiesListByTypeAndLanguageIn);
        IEnumerable<PropertiesListByTypeLanguageAndRecipeOut> PropertiesListByTypeLanguageAndRecipe(PropertiesListByTypeLanguageAndRecipeIn propertiesListByTypeLanguageAndRecipeIn);
        ...
        IEnumerable<PropertiesByRecipeAndLanguageOut> PropertiesByRecipeAndLanguage(PropertiesByRecipeAndLanguageIn propertiesByRecipeAndLanguageIn);

        //RECIPEBOOK
        IEnumerable<RecipesInRecipeBookOut> RecipesInRecipeBook(RecipesInRecipeBookIn recipesInRecipeBookIn);
        NumberOfRecipesInsertedByUserOut NumberOfRecipesInsertedByUser(NumberOfRecipesInsertedByUserIn numberOfRecipesInsertedByUserIn);

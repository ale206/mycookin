...
namespace TaechIdeas.MyCookin.IntegrationTests.Recipe
{
    public class RecipesTests
    {
        ...
        public void RecipeByFriendlyId_Success(string friendlyId, bool includeIngredients, bool includeSteps, bool includeProperties)
        {
        ...
        public void RecipeByFriendlyIdMissing_DoNotThrowError(string friendlyId, bool includeIngredients, bool includeSteps, bool includeProperties)
        {
            //var recipeByFriendlyIdResult = _recipeManager.RecipeByFriendlyId(friendlyId, includeIngredients, includeSteps, includeProperties);
